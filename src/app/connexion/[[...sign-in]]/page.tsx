  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 bg-[#F8F9FA]">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-[#1A1A2E] mb-2">Connexion</h1>
        <p className="text-[#555B6E] mb-8">Accédez à votre espace créateur</p>

        <form
          action={async () => {
            'use server'
            await signIn('google', { redirectTo: '/espace-createur' })
          }}
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 bg-white border border-[#DEE2E6] text-[#1A1A2E] font-semibold px-6 py-3 rounded-lg hover:bg-[#F8F9FA] transition-colors shadow-sm text-base"
          >
